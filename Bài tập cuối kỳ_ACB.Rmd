...
ggplot(ACB, aes(x=open)) + geom_histogram(binwidth = 1) + geom_histogram()
ggplot(ACB, aes(x=close)) + geom_histogram(binwidth = 1) + geom_histogram()
ggplot(ACB, aes(x=high)) + geom_histogram(binwidth = 1) + geom_histogram()
ggplot(ACB, aes(x=low)) + geom_histogram(binwidth = 1) + geom_histogram()
